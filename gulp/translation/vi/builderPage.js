...
var constants_1 = require("utils/constants/constants");
exports.builderPage = {
    fields: {
        reorder: 'Việc sắp xếp này chỉ giúp bạn quản lý mục cài đặt phía dưới chứ không ảnh hưởng tới nội dung của trang.',
    },
    schema: {
        settings: {
            title: 'Cài đặt',
        ...
        error: {
            ...
            is_shopify_variable: 'Bạn không thể đặt biến tên "%% name %%" vì nó là biến của shopify',
        },
    },
    theme_settings: {
        general: {
    ...
    page_settings: {
        ...
        import: {
            title: 'Nhập tệp',
            text: "T\u1EA3i l\u00EAn t\u1EC7p *.".concat(constants_1.Consts.AppName, " \u0111\u1EC3 ti\u1EBFp t\u1EE5c ch\u1EC9nh s\u1EEDa trang hi\u1EC7n t\u1EA1i"),
