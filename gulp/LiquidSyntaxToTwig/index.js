...
exports.liquidSyntaxToTwig = exports.LiquidSyntaxToTwigError = exports.handleGetTwigScope = exports.handleClauseInTagShopify = exports.VARIABLES_NAME = void 0;
...
var liquidSyntaxToTwig = function (_a) {
    ...
    // Lỗi trong code
    (0, getExceptionOfCodeLiquid_1.getExceptionOfCodeLiquid)({ liquid: liquid, settings: settings });
    var _twig = (0, ramda_1.compose)(function (liquid) {
        ...
        _liquid = (0, handlBOCDelimiters_1.handleBOCDelimiters)(_liquid);
        _liquid = (0, theme_tags_1.liquid)(_liquid); // Cái này là "theme_tags" (không liên quan đến tiền xử lí) nhưng bắt buộc thực hiện trước (chỉ sau 2 cái trên)
        ...
        // Operators
        _liquid = (0, operators_1.contains)(_liquid);
        // Filters
        ...
        _liquid = (0, filters_1.url_decode)(_liquid);
...
Object.defineProperty(exports, "LiquidSyntaxToTwigError", { enumerable: true, get: function () { return Error_1.LiquidSyntaxToTwigError; } });
